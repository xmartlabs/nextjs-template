...
_.env, .env.development, and .env.production files should be included in your repository as they define defaults. .env\*.local should be added to .gitignore, as those files are intended to be ignored. .env.local is where secrets can be stored, **DO NOT store secrets in the .env.development or .env.production file, instead use .env.local for this purpose**._
